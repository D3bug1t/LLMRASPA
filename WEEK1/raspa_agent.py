...
"""
    ...
    # Run Full Simulation
    # ---------------------------------
    def run(self, simulation_block: Dict[str, Any], selected_framework: str):
        ...
        # print("✔ simulation.input generated")
        print("\n📄 Generated RASPA input file:")
        print("-"*40)
        print(content[:500])  # show first 500 chars
        print("-"*40)


        # Run RASPA (adjust command if needed)
        # print("⚙ Running RASPA...")
